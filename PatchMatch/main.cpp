...

{
	...
	/* #################################################################################### */
	string dir_path = "E:/DesktopFile/Carmer/paper-gradutation/shuthesis-2.0/ch4/myExampare/PatchMatch";


	cv::Directory dir;
	vector<string> fileNames = dir.GetListFiles(dir_path, "*targets.png", true);

	for (vector<string>::iterator it = fileNames.begin(); it != fileNames.end(); ++it)
	{
		cout << *(it) << endl;
		int pos = (*it).find_last_of('-');
		string input = (*it).substr(0, pos);

		input = input + "-inputs.png";

		char *fileNameInput = const_cast<char*>( (*it).c_str() );
		char *fileNameMasked = const_cast<char*>( input.c_str() );
		//}
		...
		//char fileNameInput[150] = "sceneComplete\\1-left-image_00000117_0-conditions.png";
		//char fileNameMasked[150] = "sceneComplete\\1-left-image_00000117_0-inputs.png";
